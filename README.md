...
3) Ejecutar scrip_act1.sh de la siguiente manera: ./scrip_act1.sh
4) En caso de no poder ejecutarlo, darle permiso al .sh con el comando chmod +x ./scrip_act1.sh y volver a paso 3.
5) En caso de no poder ejectuarlo debe instalar dos2unix (sudo apt-get install dos2unix)
6) Ejecutar dos2unix scrip_act1.sh y volver a paso 3
------------------------------------------------------
Ejecutar act3
1) Compilar act3 : g++ act3.cpp TowerSketch.cpp CountMin_CU.cpp CountSketch.cpp -o act3
2) Ejecutar scrip_act3.sh
